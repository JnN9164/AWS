...
$order_query = mysqli_query($conn, "SELECT * FROM orders WHERE id = $order_id AND user_id = {$_SESSION['user_id']}");
...
<div class="container mt-5">
  ...
  <a href="order_history.php" class="btn btn-secondary mt-3">Back to Orders</a>
</div>
</body>
</html>
